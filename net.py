...
class UNet_2D(nn.Module):
    ...
    #ref: https://discuss.pytorch.org/t/pytorch-how-to-initialize-weights/81511/4
    ...
    def _block(in_features, out_features):               
        return nn.Sequential(OrderedDict([
                    ("conv1",nn.Conv2d(
                        ...
                        padding=1,
                        bias=False)),
                    #("norm1", nn.GroupNorm(num_groups= 8, num_channels=out_features)),
                    ...
                    ("conv2",nn.Conv2d(
                        ...
                        padding=1,
                        bias=False)),
                    #("norm2", nn.GroupNorm(num_groups= 8, num_channels=out_features)),
